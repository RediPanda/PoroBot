 ...
 */
export default class StopCMD extends InteractionEvent {
    constructor() {
    ...
    override register(): any { // The any is a cheat here as we need to directly change the data.
        ...
        return {
            description: "Stops the metric timer.",
            name: "stop",
            type: "CHAT_INPUT",
            options: [{
                type: 3,
                name: "metric",
                description: "Choose the type of metrics you wish to stop the timer for.",
                choices: [
    ...
    override async execute(interaction: CommandInteraction): Promise<void> {
        ...
        UP.MeasureStatistics(Status.AVAILABLE, metric as MetricType);

        // Create embed.
        EMBED.setColor("GREEN")
        EMBED.setDescription(`You have successfully stopped the timer for \`${metric}\``);
